...
export default () => (
  <Hero>
    ...
    <FlexContainer>
      <FlexBox>
        <Item>
          <Circle tabindex="-1" href="mailto:contact@wbsurveys.ca"><FontAwesomeIcon class="icon" icon={faEnvelope}/></Circle>
          <Title>Email</Title>
          <Content href="mailto:contact@wbsurveys.ca">contact@wbsurveys.ca</Content>
        </Item>
        <Item>
